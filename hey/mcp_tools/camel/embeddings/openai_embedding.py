...
from hey.mcp_tools.camel.embeddings.base import BaseEmbedding
from hey.mcp_tools.camel.types import NOT_GIVEN, EmbeddingModelType, NotGiven
from hey.mcp_tools.camel.utils import api_keys_required
