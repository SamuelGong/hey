...
from hey.mcp_tools.camel.prompts.ai_society import (
    AISocietyPromptTemplateDict,
    TextPromptDict,
)
from hey.mcp_tools.camel.prompts.code import CodePromptTemplateDict
from hey.mcp_tools.camel.prompts.evaluation import (
    EvaluationPromptTemplateDict,
)
from hey.mcp_tools.camel.prompts.generate_text_embedding_data import (
    GenerateTextEmbeddingDataPromptTemplateDict,
)
from hey.mcp_tools.camel.prompts.image_craft import ImageCraftPromptTemplateDict
from hey.mcp_tools.camel.prompts.misalignment import MisalignmentPromptTemplateDict
from hey.mcp_tools.camel.prompts.multi_condition_image_craft import (
    MultiConditionImageCraftPromptTemplateDict,
)
from hey.mcp_tools.camel.prompts.object_recognition import (
    ObjectRecognitionPromptTemplateDict,
)
from hey.mcp_tools.camel.prompts.role_description_prompt_template import (
    RoleDescriptionPromptTemplateDict,
)
from hey.mcp_tools.camel.prompts.solution_extraction import (
    SolutionExtractionPromptTemplateDict,
)
from hey.mcp_tools.camel.prompts.translation import TranslationPromptTemplateDict
from hey.mcp_tools.camel.prompts.video_description_prompt import (
    VideoDescriptionPromptTemplateDict,
)
from hey.mcp_tools.camel.types import TaskType
