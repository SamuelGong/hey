...
from hey.mcp_tools.camel.interpreters import BaseInterpreter, SubprocessInterpreter
from hey.mcp_tools.camel.types import RoleType
from hey.mcp_tools.camel.utils import get_system_information
...
class TextPrompt(str):
    ...
    def key_words(self) -> Set[str]:
        ...
        from hey.mcp_tools.camel.utils import get_prompt_template_key_words
