from hey.mcp_tools.camel.loaders.chunkr_reader import ChunkrReader
...
from hey.mcp_tools.camel.toolkits import ImageAnalysisToolkit, AudioAnalysisToolkit, VideoAnalysisToolkit, ExcelToolkit
...
from hey.mcp_tools.camel.models import OpenAIModel, DeepSeekModel
...
class DocumentProcessingToolkit(BaseToolkit):
    ...
    def __init__(self, cache_dir: Optional[str] = None):
        ...
        self.image_tool = ImageAnalysisToolkit(model=image_model)
    ...
    def extract_document_content(self, document_path: str) -> Tuple[bool, str]:
        ...
        if self._is_webpage(document_path):
            ...
            # Zhifeng
                ...
                logger.error(f"Do not support this type of file")
                return False, f"Do not support this type of file"
    ...
    def _extract_webpage_content(self, url: str) -> str:
        ...
        logger.debug(f"Extractred data from {url}: {resp}")
        ...
        return str(resp.data[0].markdown)
