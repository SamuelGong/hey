...
class AudioAnalysisToolkit(BaseToolkit):
    ...
    def __init__(self, cache_dir: Optional[str] = None, reasoning: bool = False):
        ...
        self.client_2 = openai.AzureOpenAI(
            api_key=os.getenv("AZURE_OPENAI_API_KEY_2"),
            api_version=os.getenv("AZURE_OPENAI_API_VERSION_2"),
            azure_endpoint=os.getenv("AZURE_OPENAI_BASE_URL_2")
        )
    ...
    def ask_question_about_audio(self, audio_path: str, question: str) -> str:
        ...
        if self.reasoning:
            ...
            # )
            transcription = self._client_2.audio.transcriptions.create(
                model="whisper", file=open(audio_path, "rb")
            )
