...
from hey.mcp_tools.camel.models import OpenAIAudioModels, BaseModelBackend
...
class VideoAnalysisToolkit(BaseToolkit):
    ...
    def __init__(
        ...
        # logging.info(f"[ZHIFENG DEBUG]: A {model}")
        self.vl_model = model
        # logging.info(f"[ZHIFENG DEBUG]: B {self.vl_model}")
        # logging.info(f"[ZHIFENG DEBUG]: C {self}")
    ...
    def ask_question_about_video(
        ...
        # logging.info(f"[ZHIFENG DEBUG]: -1 {self}")
        # logging.info(f"[ZHIFENG DEBUG]: 0 {self.vl_model}")
        # logging.info(f"[ZHIFENG DEBUG]: 1 {msg}")
        response = self.vl_agent.step(msg)
        # logging.info(f"[ZHIFENG DEBUG]: 2 {response}")
