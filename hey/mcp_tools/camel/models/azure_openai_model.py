...
from hey.mcp_tools.camel.configs import OPENAI_API_PARAMS, ChatGPTConfig
...
from hey.mcp_tools.camel.utils import BaseTokenCounter, OpenAITokenCounter, api_keys_required
...
class AzureOpenAIModel(BaseModelBackend):
    ...
    def __init__(
        ...
        if self.api_version is None:
            raise ValueError(
                ...
                "or `AZURE_OPENAI_API_VERSION` environment variable."
            )
    ...
    @api_keys_required("AZURE_OPENAI_API_KEY", "AZURE_OPENAI_API_VERSION")
    def run(
        self,
